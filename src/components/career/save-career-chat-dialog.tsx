...
interface SaveCareerChatDialogProps {
  isOpen: boolean;
  onSave: () => void;
  onDiscard: () => void;
  chatId?: string;
        ...
        <div className="text-center">
          <div className="mb-4">
            ...
            <h3 className="text-lg font-medium text-[#02133B] mb-2">
              Save this career journey?
            </h3>
            <p className="text-sm text-gray-600">
              Do you want to save this career discovery session to your chat history? If you don't save it, the conversation will be permanently deleted.
            </p>
          </div>
